                ...
                <form method="post" action="{{ route('pinjam.update',$pinjam->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="nama" id="nama" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('nama', $pinjam->nama) }}" />
                            @error('nama')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="alamat" id="alamat" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('alamat', $pinjam->alamat) }}" />
                            @error('alamat')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="number" name="jumlahpinjam" id="jumlahpinjam" onkeyup="calculateUpdate()" type="number" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('jumlahpinjam', $pinjam->jumlahpinjam) }}" />
                            @error('jumlahpinjam')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select name="cicil" id="cicil" type="text" onclick="calculateTotal(this.value)" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('cicil', $pinjam->cicil) }}">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="number" name="bunga" id="bunga" type="number" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('bunga', $pinjam->bunga) }}" readonly />
                            @error('bunga')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="date" name="tanggal" id="tanggal" type="date" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('tanggal', $pinjam->tanggal) }}" />
                            @error('tanggal')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="status" class="block font-medium text-sm text-gray-700">Status</label>
                            <select name="status" id="status" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('status', $pinjam->status) }}">
